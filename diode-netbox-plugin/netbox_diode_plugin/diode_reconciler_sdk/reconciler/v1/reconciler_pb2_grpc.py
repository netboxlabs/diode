...
from netbox_diode_plugin.diode_reconciler_sdk.reconciler.v1 import reconciler_pb2 as reconciler_dot_v1_dot_reconciler__pb2
...
class ReconcilerService(object):
    ...
    def RetrieveIngestionDataSources(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/reconciler.v1.ReconcilerService/RetrieveIngestionDataSources',
