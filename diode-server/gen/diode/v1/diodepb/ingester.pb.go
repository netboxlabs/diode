...
type IPAddress struct {
	...
	// Types that are valid to be assigned to AssignedObject:
	//
	//	*IPAddress_Interface
...
func (x *IPAddress) GetAssignedObject() isIPAddress_AssignedObject {
	if x != nil {
...
func (x *IPAddress) GetInterface() *Interface {
	if x != nil {
		if x, ok := x.AssignedObject.(*IPAddress_Interface); ok {
			return x.Interface
		}
	}
	return nil
...
func (x *Entity) GetSite() *Site {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Site); ok {
			return x.Site
		}
	}
	return nil
...
func (x *Entity) GetPlatform() *Platform {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Platform); ok {
			return x.Platform
		}
	}
	return nil
...
func (x *Entity) GetManufacturer() *Manufacturer {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Manufacturer); ok {
			return x.Manufacturer
		}
	}
	return nil
...
func (x *Entity) GetDevice() *Device {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Device); ok {
			return x.Device
		}
	}
	return nil
...
func (x *Entity) GetDeviceRole() *Role {
	if x != nil {
		if x, ok := x.Entity.(*Entity_DeviceRole); ok {
			return x.DeviceRole
		}
	}
	return nil
...
func (x *Entity) GetDeviceType() *DeviceType {
	if x != nil {
		if x, ok := x.Entity.(*Entity_DeviceType); ok {
			return x.DeviceType
		}
	}
	return nil
...
func (x *Entity) GetInterface() *Interface {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Interface); ok {
			return x.Interface
		}
	}
	return nil
...
func (x *Entity) GetIpAddress() *IPAddress {
	if x != nil {
		if x, ok := x.Entity.(*Entity_IpAddress); ok {
			return x.IpAddress
		}
	}
	return nil
...
func (x *Entity) GetPrefix() *Prefix {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Prefix); ok {
			return x.Prefix
		}
	}
	return nil
...
func (x *Entity) GetClusterGroup() *ClusterGroup {
	if x != nil {
		if x, ok := x.Entity.(*Entity_ClusterGroup); ok {
...
func (x *Entity) GetClusterType() *ClusterType {
	if x != nil {
		if x, ok := x.Entity.(*Entity_ClusterType); ok {
...
func (x *Entity) GetCluster() *Cluster {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Cluster); ok {
			return x.Cluster
		}
	}
	return nil
...
func (x *Entity) GetVirtualMachine() *VirtualMachine {
	if x != nil {
		if x, ok := x.Entity.(*Entity_VirtualMachine); ok {
			return x.VirtualMachine
		}
	}
	return nil
...
func (x *Entity) GetVminterface() *VMInterface {
	if x != nil {
		if x, ok := x.Entity.(*Entity_Vminterface); ok {
...
func (x *Entity) GetVirtualDisk() *VirtualDisk {
	if x != nil {
		if x, ok := x.Entity.(*Entity_VirtualDisk); ok {
