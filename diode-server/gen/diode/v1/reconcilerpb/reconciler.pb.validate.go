...
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *DiodeEntity) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DiodeEntity with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in DiodeEntityMultiError, or
// nil if none found.
func (m *DiodeEntity) ValidateAll() error {
	return m.validate(true)
}

func (m *DiodeEntity) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, DiodeEntityValidationError{
					field:  "Entity",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return DiodeEntityValidationError{
				field:  "Entity",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	// no validation rules for LastSeenTs

	// no validation rules for DuplicateCount

	if len(errors) > 0 {
		return DiodeEntityMultiError(errors)
	}

	return nil
}

// DiodeEntityMultiError is an error wrapping multiple validation errors
// returned by DiodeEntity.ValidateAll() if the designated constraints aren't met.
type DiodeEntityMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DiodeEntityMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DiodeEntityMultiError) AllErrors() []error { return m }

// DiodeEntityValidationError is the validation error returned by
// DiodeEntity.Validate if the designated constraints aren't met.
type DiodeEntityValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DiodeEntityValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DiodeEntityValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DiodeEntityValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DiodeEntityValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DiodeEntityValidationError) ErrorName() string { return "DiodeEntityValidationError" }

// Error satisfies the builtin error interface
func (e DiodeEntityValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = DiodeEntityValidationError{}
...
func (m *ListEntitiesRequest) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetMetadataFilters()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ListEntitiesRequestValidationError{
					field:  "MetadataFilters",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetMetadataFilters()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
	...
	if m.IngestionTsStart != nil {
		// no validation rules for IngestionTsStart
	}

	if m.IngestionTsEnd != nil {
		// no validation rules for IngestionTsEnd
	}
