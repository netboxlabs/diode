...
type Config struct {
	...
	GraphUpsertProcessorBatchSize   int32 `envconfig:"GRAPH_UPSERT_PROCESSOR_BATCH_SIZE" default:"100"`
	GraphUpsertProcessorConcurrency int   `envconfig:"GRAPH_UPSERT_PROCESSOR_CONCURRENCY" default:"1"`
	GraphUpsertProcessorMaxAttempts int32 `envconfig:"GRAPH_UPSERT_PROCESSOR_MAX_ATTEMPTS" default:"5"`
