...
// RedisClient_Pipeline_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Pipeline'
type RedisClient_Pipeline_Call struct {
	*mock.Call
}

// Pipeline is a helper method to define mock.On call
func (_e *RedisClient_Expecter) Pipeline() *RedisClient_Pipeline_Call {
	return &RedisClient_Pipeline_Call{Call: _e.mock.On("Pipeline")}
}

func (_c *RedisClient_Pipeline_Call) Run(run func()) *RedisClient_Pipeline_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *RedisClient_Pipeline_Call) Return(_a0 redis.Pipeliner) *RedisClient_Pipeline_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RedisClient_Pipeline_Call) RunAndReturn(run func() redis.Pipeliner) *RedisClient_Pipeline_Call {
	_c.Call.Return(run)
	return _c
}
