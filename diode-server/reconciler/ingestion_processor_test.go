...
func TestNewIngestionProcessor(t *testing.T) {
	...
	nbClient, err := netboxdiodeplugin.NewClient(logger, cfg.DiodeClientID, cfg.DiodeClientSecret, cfg.DiodeAuthTokenUrl, cfg.DiodeToNetBoxRateLimiterRPS, cfg.DiodeToNetBoxRateLimiterBurst)
