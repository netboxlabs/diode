...
class IngestEntity(_message.Message):
    __slots__ = ("site", "platform", "manufacturer", "device", "device_role", "device_type", "interface", "timestamp")
...
class PushRequest(_message.Message):
    __slots__ = ("stream", "data", "id", "producer_app_name", "producer_app_version", "sdk_name", "sdk_version")
    ...
    stream: str
    data: _containers.RepeatedCompositeFieldContainer[IngestEntity]
    id: str
    producer_app_name: str
    producer_app_version: str
    sdk_name: str
    sdk_version: str
    def __init__(self, stream: _Optional[str] = ..., data: _Optional[_Iterable[_Union[IngestEntity, _Mapping]]] = ..., id: _Optional[str] = ..., producer_app_name: _Optional[str] = ..., producer_app_version: _Optional[str] = ..., sdk_name: _Optional[str] = ..., sdk_version: _Optional[str] = ...) -> None: ...
