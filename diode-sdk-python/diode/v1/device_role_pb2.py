...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    b'\n\x1a\x64iode/v1/device_role.proto\x12\x08\x64iode.v1\x1a\x17validate/validate.proto\"\x91\x01\n\nDeviceRole\x12\"\n\x04name\x18\x01 \x01(\tB\t\xfa\x42\x06r\x04\x10\x01\x18\x64H\x00R\x04name\x88\x01\x01\x12\x34\n\x04slug\x18\x02 \x01(\tB\x1b\xfa\x42\x18r\x16\x10\x01\x18\x64\x32\x10^[-a-zA-Z0-9_]+$H\x01R\x04slug\x88\x01\x01\x12\x17\n\x07vm_role\x18\x03 \x01(\x08R\x06vmRoleB\x07\n\x05_nameB\x07\n\x05_slugBDZBgithub.com/netboxlabs/diode-internal/diode-sdk-go/diode/v1/diodepbb\x06proto3')
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_DEVICEROLE']._serialized_start = 66
    _globals['_DEVICEROLE']._serialized_end = 211
